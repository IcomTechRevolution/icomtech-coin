...
This mechanism has been integrated into Bitcore-Node-IcomTech which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/icomtechpay/insight-api-icomtech#web-socket-api](https://github.com/icomtechpay/insight-api-icomtech#web-socket-api)
* API: [https://github.com/icomtechpay/insight-api-icomtech#instantsend-transactions](https://github.com/icomtechpay/insight-api-icomtech#instantsend-transactions)
