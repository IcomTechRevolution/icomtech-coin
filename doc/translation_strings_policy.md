...
This document provides guidelines for internationalization of the IcomTech Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `icomtech_en.ts` remains unchanged.
