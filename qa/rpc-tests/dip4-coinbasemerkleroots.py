...
class LLMQCoinbaseCommitmentsTest(IcomTechTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as IcomTechTestFramework doesn't support this atm)
