...
2. run icomtechd with -printalert or -sendalert like this:
   /path/to/icomtechd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.icomtech.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/IcomTech Core:0.12.0.58/"));
