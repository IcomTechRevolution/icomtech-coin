...
// Copyright (c) 2019 The IcomTech Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1565284211, nBits=1e0ffff0, nNonce=1660029, vtx=1)
...
{
    const char* pszTimestamp = "Icomtech Revolution";
    const CScript genesisOutputScript = CScript() << ParseHex("04737e5f9214fc53a0a4d5ac6ad33c600274eb5bfca355d3b1c2fa4e705c2526ecec3edfeaed787ea1595aeb513a654bb17c240f8de272a6db534e3c40d3e64018") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000c79521464c34d4f2402a59c49c1ed8226d25d2e7a862cecede179981a22"); 
        ...
        vAlertPubKey = ParseHex("043ab223387b2ed85e2229cbc3b12a9a3733729b57db2a1c18d15d165c6d75d291688183d8d46635f13642566dd16944798d63cc3fc98ece4bf81083097bb4892d");
        nDefaultPort = 11512;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1565284211, 1660029, 0x1e0ffff0, 1, 800 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000c79521464c34d4f2402a59c49c1ed8226d25d2e7a862cecede179981a22"));
        assert(genesis.hashMerkleRoot == uint256S("0x072d7d9be2217186019455b5215abf8ab12a08b1f863593bc75a3a3596755cec"));


        vSeeds.push_back(CDNSSeedData("icomtech.org", "coinnode1.icomtech.org"));
        vSeeds.push_back(CDNSSeedData("n2.icomtech.org", "coinnode2.icomtech.org"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,66);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,193);
        // IcomTech BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // IcomTech BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // IcomTech BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"TW2RMP4YXThkUu47Ud2qYo2cPHW8AxfAoS"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000c79521464c34d4f2402a59c49c1ed8226d25d2e7a862cecede179981a22"))
        };

        chainTxData = ChainTxData{
            1565284211, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000b842bc5c65212ea3f3ff8d828af55f4a2a36c9d23dda2c429142c01e896"); 

        pchMessageStart[0] = 0x97;
        pchMessageStart[1] = 0x85;
        pchMessageStart[2] = 0x7d;
        pchMessageStart[3] = 0x7a;
        vAlertPubKey = ParseHex("04acdfb25301d426a3a792f7104dfa22c6238a569e838bb5b0b0e69ad0a7fc2aa0f159f50130d2836fdc855052f0c048392f623a2d07a52f78f70c6fb31fed65b9");
        nDefaultPort = 21512;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1565284216UL, 457916UL, 0x1e0ffff0, 1, 800 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000b842bc5c65212ea3f3ff8d828af55f4a2a36c9d23dda2c429142c01e896"));
        assert(genesis.hashMerkleRoot == uint256S("0x072d7d9be2217186019455b5215abf8ab12a08b1f863593bc75a3a3596755cec"));
        ...
        // Testnet IcomTech BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet IcomTech BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet IcomTech BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"MRHg8uLzYjK7MjDLUNuusxN6hb9x1v21zz"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000b842bc5c65212ea3f3ff8d828af55f4a2a36c9d23dda2c429142c01e896"))
        };

        chainTxData = ChainTxData{
            1565284216, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1565284221, 0, 0x207fffff, 1, 800 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x323006dbad6c1720fe710e27bb3b3ebc5703fa7e56822c335230927642d2f4de"));
        assert(genesis.hashMerkleRoot == uint256S("0x072d7d9be2217186019455b5215abf8ab12a08b1f863593bc75a3a3596755cec"));

        devnetGenesis = FindDevNetGenesisBlock(consensus, genesis, 800 * COIN);
        consensus.hashDevnetGenesisBlock = devnetGenesis.GetHash();

        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("icomtechevo.org",  "devnet-seed.icomtechevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x323006dbad6c1720fe710e27bb3b3ebc5703fa7e56822c335230927642d2f4de"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6yDur3stF4S52CDJ4SMnEsgsY2eYvDdnNqK1MyDva54j2UkmDzC
        vSporkAddresses = {"MVEinye88EKs3iaB7ELgQt3YY9pkwgwcEa"};
        nMinSporkKeys = 1;
        ...
        // Regtest IcomTech addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,50);
        // Regtest IcomTech script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,51);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,178);
        // Regtest IcomTech BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest IcomTech BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest IcomTech BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
