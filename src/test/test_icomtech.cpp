...
#define BOOST_TEST_MODULE IcomTech Test Suite

#include "test_icomtech.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_icomtech_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
