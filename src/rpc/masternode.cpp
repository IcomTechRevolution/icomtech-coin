...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner IcomTech address\n"
            "  payee          - Print the masternode payout IcomTech address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting IcomTech address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "icomtech",               "masternode",             &masternode,             true,  {} },
    { "icomtech",               "masternodelist",         &masternodelist,         true,  {} },
    { "icomtech",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "icomtech",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
