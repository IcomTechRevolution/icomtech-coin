/* src/config/icomtech-config.h.  Generated from icomtech-config.h.in by configure.  */
/* src/config/icomtech-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ICOM_CONFIG_H

#define ICOM_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The IcomTech Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "IcomTech Core"
...
#define PACKAGE_BUGREPORT "https://github.com/icomtechpay/icomtech/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "IcomTech Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "IcomTech Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "icomtechcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://icomtech.org/"
