...
//! These need to be macros, as clientversion.cpp's and icomtech*-res.rc's voodoo requires it
...
/**
 * icomtechd-res.rc includes this file, but it cannot cope with real c++ code.
