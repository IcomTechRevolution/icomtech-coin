...
Arguments:
    <base_directory> - The base directory of a IcomTech Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The IcomTech Core developers'
...
Arguments:
    <base_directory> - The base directory of IcomTech Core source code repository.
"""
...
Arguments:
    <file> - A source file in the IcomTech Core repository.
"""
